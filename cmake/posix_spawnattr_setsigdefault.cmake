...
if (HAVE_SPAWN_H)
  ...
  set(HAVE_POSIX_SPAWNATTR_SETSIGDEFAULT "" CACHE INTERNAL "")
endif ()

set(LIBCFUNK_DECLARE_POSIX_SPAWNATTR_SETSIGDEFAULT "1" CACHE INTERNAL "")

if (NOT HAVE_POSIX_SPAWNATTR_SETSIGDEFAULT)

...
if (HAVE_PTY_H OR HAVE_LIBUTIL_H OR HAVE_UTIL_H)
  ...
  check_symbol_exists("forkpty" "${FORKPTY_INCLUDES}" HAVE_FORKPTY_IN_LIBC)
  if (NOT HAVE_FORKPTY_IN_LIBC)
    check_library_exists("util" "forkpty" "" HAVE_FORKPTY_IN_LIBUTIL)
    if (HAVE_FORKPTY_IN_LIBUTIL)
      target_link_libraries("$CACHE{LIBCFUNK_LIBRARY_NAME}" PUBLIC "util")
      list(APPEND CMAKE_REQUIRED_LIBRARIES "util")
      list(REMOVE_DUPLICATES CMAKE_REQUIRED_LIBRARIES)
    endif ()
  endif ()
  if (HAVE_FORKPTY_IN_LIBC OR HAVE_FORKPTY_IN_LIBUTIL)
    set(HAVE_FORKPTY "1" CACHE STRING "")
  endif ()
  if (HAVE_FORKPTY)
